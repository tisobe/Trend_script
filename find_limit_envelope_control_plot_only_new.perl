...
#########################################################################################
#											#
#	find_limit_envelope_control_plot_only_new.perl: this is dataseeker data version	#
#				and recompute for the entire period.			#
#                               using: find_limit_plot_long_term_recomp_fit.perl	#
#											#
#											#
